...
#[-0.79,-0.11,-2.33,1.94,1.14,-3.68]
    ...
    # 1. This implementation is not working
    R0_3nw= R0_3.subs({q1: theta1, q2: theta2, q3: theta3})
    R0_3nw = R0_3nw.evalf()

    # 2. This implementation is working    
    R0_3w = R0_3.evalf(subs={q1: theta1, q2: theta2, q3: theta3})

    # Printing the matrices in order to compare     
    print("R0_3 working is:/n", R0_3w)
    print(" ")
    print("R0_3 not working is:", R0_3nw)


    # Choose one to check calculations
    R0_3 = R0_3w
    #R0_3 = R0_3nw
